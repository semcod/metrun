...
def _format_critical_path_section(records: Optional[Dict[str, 'FunctionRecord']]) -> List[str]:
...
def _format_summary(worst: Bottleneck) -> List[str]:
    ...
    return ['── Summary ───────────────────────────────────', f'   Top bottleneck : {worst.name}', f'   Score          : {worst.score}', f'   Diagnosis      : {worst.diagnosis}', '']
...
def generate_report(bottlenecks: List[Bottleneck], *, title: str='METRUN PERFORMANCE REPORT', top_n: Optional[int]=None, show_graph: bool=True, show_suggestions: bool=False, records: Optional[Dict[str, 'FunctionRecord']]=None, show_critical_path: bool=False) -> str:
    """
...
def print_report(bottlenecks: List[Bottleneck], *, title: str='METRUN PERFORMANCE REPORT', top_n: Optional[int]=None, show_graph: bool=True, show_suggestions: bool=False, records: Optional[Dict[str, 'FunctionRecord']]=None, show_critical_path: bool=False) -> None:
    """Print the performance report to stdout."""
    print(generate_report(bottlenecks, title=title, top_n=top_n, show_graph=show_graph, show_suggestions=show_suggestions, records=records, show_critical_path=show_critical_path))